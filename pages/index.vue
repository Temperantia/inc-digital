<template>
  <v-layout column justify-center align-center>
    <v-img width="100%" src="/header.png">
      <v-col cols="4" offset="8" style="height: 100%;">
        <div style="position: absolute; right: 10%; bottom: 10%; font-size: 3vw; color: white;">
          <div class="pl-10">We help you create</div>
          <div class="pl-5">a better future</div>
    ...
    <v-container id="home" width="50" class="text-center">
      ...
      <v-row>
        <v-col>We’re a software development agency located in Paris, France</v-col>
      </v-row>
      <v-row>
      ...
      <v-row>
        <v-col>Our workflow : a strategy to help you improve the efficiency, overall revenue, and day-to-day operations of your business. It allows us anticipates the need for flexibility and applies a level of pragmatism to the delivery of the finished product.</v-col>
      </v-row>
      <v-row>
        <v-col align="center">
          <v-img width="100" src="/icon-communicate.png"></v-img>
          <h4>01. Communicate</h4>
          <p>We begin every client project with strategic curiosity. We ask questions designed to understand what our clients want and need. Strong communication looks different at each stage of our process, but it is equally vital every step of the way.</p>
        </v-col>
        <v-col align="center">
        ...
        <v-col align="center">
          ...
          <h4>04. Develop</h4>
          <p>Development phase is about transforming the design of a system into a computer language format. This coding phase of software development is concerned with software translating design specification into the source code.</p>
        </v-col>
      </v-row>
      <v-row>
        <v-col align="center">
